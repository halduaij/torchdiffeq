...
class _Base(RKAdaptiveStepsizeODESolver):
    ...
    def _adaptive_step(self, st: _RKState) -> _RKState:
        ...
        # (1) explicit predictor (cheap, order-(p-1))
        y_pred, _, _, k_pred = _runge_kutta_step(
        ...
        # rejected step – shrink dt, retry later
...
class AdaptiveRadauIIA3(_Base):
    ...
    tableau = _ButcherTableau(
        ...
        # append trailing zero so length == stages+1
